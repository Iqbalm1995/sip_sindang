...
class Model_laporan8 extends CI_Model {
    ...
    public function get_laporan8($tahun = null, $bulan = null, $desa = 'all')
	{
		if ($tahun == null) {
			$tahun = date('Y');
		}
        ...
        if ($bulan == null) {
			$bulan = date('m');
                ...
                $this->db->select('cm.id AS "id", cm.nama AS "pos"');
