...
<script type="text/javascript">
    ...
    function exportData() {
        ...
        document.location = "<?php echo base_url('balita/export/')?>" + ExfilterYear + "/" + ExfilterMonth;
    }
    ...
    function chartTimbangan(year) {
        ...
        $.ajax({
            url : "<?= base_url('balita/get_statistik_balita_json')?>",
            type: "POST",
            data: {
                filterYear: year,
            },
            ...
            success: function(response) {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Kunjungan Layanan Balita',
                        data: valuesCht,
                        borderWidth: 2,
