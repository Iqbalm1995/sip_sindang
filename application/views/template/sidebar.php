<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li <?=( $menu_active == 'dashboard' ? 'class="active"' : '' );?>><a class="nav-link" href="#"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
            <li <?=( $menu_active == 'blank' ? 'class="active"' : '' );?>><a class="nav-link" href="<?= base_url('blank'); ?>"><i class="fa fa-square"></i> <span>Blank</span></a></li>
            ...
            <li <?=( $menu_active == 'users' ? 'class="active"' : '' );?>><a class="nav-link" href="#"><i class="fas fa-user"></i> <span>Pengguna</span></a></li>
