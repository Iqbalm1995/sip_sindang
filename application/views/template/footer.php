<footer class="main-footer">
  ...
  <script src="<?=base_url('/assets/theme/stisla/');?>modules/chocolat/dist/js/jquery.chocolat.min.js"></script>
  <script src="<?=base_url('/assets/theme/stisla/');?>modules/bootstrap-daterangepicker/daterangepicker.js"></script>
