        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 pr-0 pl-1 inputFilterCenter">
                        <button class="btn btn-primary tombolfull" style="width:100%; height:42px;" id="filterBtn" href="javascript:void(0)" title="Hapus" onclick="exportData()"><i class="fas fa-file-export"></i> Export Data Bayi </button>
                    </div>
                </div>
            </div>
        </div>
